...
export const SidebarFilters = ({
  ...
  return (
    <Card className={tailwindClasses.surface}>
      <CardHeader
        className={`flex flex-row items-center space-x-2 ${tailwindClasses.border} border-b p-4`}
      >
      ...
      <CardContent className="p-4 space-y-4">
        ...
        <Accordion type="single" collapsible defaultValue="insurance-type">
          <AccordionItem value="insurance-type">
            <AccordionTrigger
              className={`${tailwindClasses.textDark} hover:no-underline`}
            >
              Insurance Type
            </AccordionTrigger>
            <AccordionContent>
...
export const QuickActionsSidebar = () => {
  ...
  return (
    <Card className={`${tailwindClasses.surface} shadow-md `}>
      <CardHeader>
        <CardTitle
          className={`${tailwindClasses.textDark} ${typography.headings}`}
        >
          Quick Actions
        </CardTitle>
      </CardHeader>
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-4"></DialogTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <div className="mt-1 p-2 bg-gray-100 rounded">{premium}</div>
              </div>
            </div>
...
export const Sidebar = ({
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-[100vh] overflow-scroll z-50 w-72 bg-white dark:bg-gray-900 shadow-lg transition-transform transform ${
    ...
    >
      ...
      <div className="p-6 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <h1
            className={`text-xl font-semibold ${typography.headings} ${tailwindClasses.textDark}`}
          >
            InsureNet
          </h1>
        </div>
      ...
      <div className="px-6">
        ...
        <Button
          className={`${tailwindClasses.primary} hover:opacity-90 hidden md:flex`}
